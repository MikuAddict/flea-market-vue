...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.LoginUserVo();
  });
  ...
  describe('LoginUserVo', function() {
    it('should create an instance of LoginUserVo', function() {
      // uncomment below and update the code to test LoginUserVo
      //var instance = new OpenapiJsClient.LoginUserVo();
      //expect(instance).to.be.a(OpenapiJsClient.LoginUserVo);
    });
