...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.UserQueryRequest();
  });
  ...
  describe('UserQueryRequest', function() {
    it('should create an instance of UserQueryRequest', function() {
      // uncomment below and update the code to test UserQueryRequest
      //var instance = new OpenapiJsClient.UserQueryRequest();
      //expect(instance).to.be.a(OpenapiJsClient.UserQueryRequest);
    });
