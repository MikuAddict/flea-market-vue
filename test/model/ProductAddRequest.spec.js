...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.ProductAddRequest();
  });
  ...
  describe('ProductAddRequest', function() {
    it('should create an instance of ProductAddRequest', function() {
      // uncomment below and update the code to test ProductAddRequest
      //var instance = new OpenapiJsClient.ProductAddRequest();
      //expect(instance).to.be.a(OpenapiJsClient.ProductAddRequest);
    });
