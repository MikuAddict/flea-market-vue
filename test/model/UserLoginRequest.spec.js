...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.UserLoginRequest();
  });
  ...
  describe('UserLoginRequest', function() {
    it('should create an instance of UserLoginRequest', function() {
      ...
      //var instance = new OpenapiJsClient.UserLoginRequest();
      //expect(instance).to.be.a(OpenapiJsClient.UserLoginRequest);
    });
