...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.ProductUpdateRequest();
  });
  ...
  describe('ProductUpdateRequest', function() {
    it('should create an instance of ProductUpdateRequest', function() {
      ...
      //var instance = new OpenapiJsClient.ProductUpdateRequest();
      //expect(instance).to.be.a(OpenapiJsClient.ProductUpdateRequest);
    });
